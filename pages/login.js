            ...
            <div className="p-12 w-full">
              ...
              <div className="flex gap-4 justify-between mt-2">
                <button
                  ...
                  role="button"
                  className="flex justify-center items-center p-2 w-full rounded-lg border border-gray-400 shadow-md transition duration-150 ease-in-out hover:bg-gray-100 hover:shadow-lg focus:ring-2 focus:ring-gray-700 focus:ring-offset-1 focus:outline-none"
                >
                  <svg
                    width="20"
                    height="20"
