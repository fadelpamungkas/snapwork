	...
	return (
		<body>
			<div className="flex w-full grid-cols-2 items-center justify-center">
				<div className="container hidden min-h-screen items-center justify-center bg-indigo-500 md:flex">
					<div className="absolute top-0 left-0 m-16 flex items-center">
						<svg
						...
						<p className="ml-4 text-2xl font-medium text-white">Snapwork</p>
					</div>
				...
				<div className="flex min-h-screen w-full items-center justify-center bg-gray-50 p-8 dark:bg-slate-900">
					...
					<div className="w-2/3 sm:w-3/5 md:w-full lg:w-2/3">
						<h1 className="text-3xl font-bold leading-6 text-gray-800 focus:outline-none dark:text-gray-100">
							Login to your account
						</h1>
						<p className="mt-8 text-sm font-medium leading-none text-gray-800 dark:text-gray-100">
							Sign in with
						</p>
						<div className="mt-2 flex justify-between gap-4">
							<button
								...
								role="button"
								className="flex w-full items-center justify-center rounded-lg border border-gray-400 p-2 shadow-md transition duration-150 ease-in-out hover:bg-gray-100 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-1 dark:bg-gray-600"
							>
								<svg
									width="20"
									height="20"
							...
							<button
								...
								role="button"
								className="flex w-full items-center justify-center rounded-lg border border-gray-400 p-2 shadow-md transition duration-150 ease-in-out hover:bg-gray-100 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-1"
							>
								<svg
									width="20"
									height="20"
						...
						<div className="flex w-full items-center justify-between py-5">
							...
							<p className="px-2.5 text-base font-medium leading-4 text-gray-500 dark:text-gray-50">
								OR
							</p>
							<hr className="w-full bg-gray-400" />
						</div>
						<div>
							<label
								htmlFor="email"
								className="text-sm font-medium leading-none text-gray-800 dark:text-gray-100"
							>
								Email
							</label>
							<input
								...
								type="email"
								className="mt-2 w-full rounded border bg-gray-200 py-3 px-3 text-xs font-medium leading-none text-gray-800 placeholder-gray-800 shadow-md hover:shadow-lg"
						...
						<div className="mt-6 w-full">
							...
							<div className="relative flex items-center justify-center">
								<input
									...
									className="mt-2 w-full rounded border bg-gray-200 py-3 px-3 text-xs font-medium leading-none text-gray-800 shadow-md hover:shadow-lg"
								/>
								<div className="absolute right-0 mt-2 mr-3 cursor-pointer">
									...
									<div click="show = true" v-if="show === false" className>
										<svg
											xmlns="http://www.w3.org/2000/svg"
