...
export default function Signup() {
	...
	const handleSubmit = async (event) => {
		...
		const response = await fetch("https://snapwork.herokuapp.com/api/users", {
			method: "POST",
			headers: {
			...
			<div className="flex w-full grid-cols-2 items-center justify-center">
				...
				<div className="flex min-h-screen w-full items-center justify-center bg-gray-50 p-8">
					...
					<div className="w-2/3 sm:w-3/5 md:w-full lg:w-2/3">
						<h1 className="text-3xl font-bold leading-6 text-gray-800 focus:outline-none">
							Create new account
						</h1>
						<p className="mt-8 text-sm font-medium leading-none text-gray-800">
							Sign up with
						</p>
						...
						<form id="formSignUp" onSubmit={handleSubmit}>
							<div>
								...
								<input
									...
									name="name"
									type="name"
									className="mt-2 w-full rounded border bg-gray-200 py-3 px-3 text-xs font-medium leading-none text-gray-800 placeholder-gray-400 shadow-md hover:shadow-lg"
